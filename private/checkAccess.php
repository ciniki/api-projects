...
// and return a list of other modules enabled for the tenant.
//
// Arguments
// =========
// ciniki:
...
// =======
//
function ciniki_projects_checkAccess($ciniki, $tnid, $method) {
    //
    ...
    $rc = ciniki_tenants_checkModuleAccess($ciniki, $tnid, 'ciniki', 'projects');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    if( isset($rc['modules']) ) {
    ...
    //
    // Users who are an owner or employee of a tenant can see the tenant project
    //
